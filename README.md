...
<a href="mailto:jordaogranataleonardo@gmail.com">
...
<a href="https://wa.me/5517981252107">
<img src="https://img.shields.io/badge/WhatsApp-0B090A?style=for-the-badge&logo=whatsapp&logoColor=7D9A7A&labelColor=0B090A" />
</a>
...
apelido:     Leo
formacao:    Técnico em Desenvolvimento de Sistemas (2025)
cursando:    Ciência da Computação (2026 → 2029)
cargo:       Estagiário de Desenvolvimento web
foco:        FullStack Development / Arquitetura de Software
missao:      Construir sistemas escaláveis e evoluir
             como desenvolvedor
```
...
&nbsp;&nbsp;
<img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/insomnia/insomnia-original.svg" width="48" title="Insomnia"/>
&nbsp;&nbsp;
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/composer/composer-original.svg" width="48" title="Composer"/>
&nbsp;&nbsp;
...
Plataforma de **tradução de Libras em tempo real**, com foco em inclusão.

Aplicação web em Django integrada a um serviço de IA em FastAPI (MediaPipe + TensorFlow/Keras) para reconhecimento de sinais, com aplicativo Android em Kotlin.

`Django` `FastAPI` `MediaPipe` `TensorFlow` `Kotlin`
...
IA que **identifica objetos por imagem** e orienta sobre o descarte correto.

Desenvolvimento do back-end e integração entre front-end, back-end e modelo de IA.

`Python` `Django` `FastAPI` `React` `TypeScript`

**[→ Repositório](https://github.com/PedroMoraes57/Reuse-Ai)**
...
Sistema inteligente de **controle de estoque**, desenvolvido como projeto de conclusão do SENAI.

Utiliza previsão de consumo para auxiliar na tomada de decisões e planejamento de estoque.

`Python` `Django` `Prophet` `SQL`

**[→ Repositório](https://github.com/leonardogranata/StockMind)**
...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=14&duration=4000&pause=1500&color=8F7D84&center=true&vCenter=true&width=700&lines=%22Clean+code+always+looks+like+it+was+written+by+someone+who+cares.%22" />
